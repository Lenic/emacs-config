...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (dockerfile-mode markdown-mode web-mode use-package undo-tree tide spacemacs-theme rjsx-mode projectile prettier-js org-bullets neotree multiple-cursors magit json-mode htmlize git-gutter+ emmet-mode counsel company autopair amx ace-jump-mode))))
(custom-set-faces
